    ...
    internal class Lexer
    {
        ...
        private Result<long> ParseCharInternal()
        {
            ...
            if (c == '\\')
            {
                ...
                switch (c)
                {
                    case '0': result.ResultObject = 0; Advance(); break;
                    case 'a': result.ResultObject = '\a'; Advance(); break;
                    case 'b': result.ResultObject = '\b'; Advance(); break;
                    case 'e': result.ResultObject = '\e'; Advance(); break;
                    case 'f': result.ResultObject = '\f'; Advance(); break;
                    case 'n': result.ResultObject = '\n'; Advance(); break;
                    case 'r': result.ResultObject = '\r'; Advance(); break;
                    case 't': result.ResultObject = '\t'; Advance(); break;
                    case 'v': result.ResultObject = '\v'; Advance(); break;
                    case '\'': result.ResultObject = '\''; Advance(); break;
                    case '"': result.ResultObject = '"'; Advance(); break;
                    case 'x':
                    {
